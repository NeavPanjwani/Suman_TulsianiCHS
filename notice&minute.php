        ...
        <!--<div class="container-fluid px-5">
            <div class="row align-items-center">-->
                ...
                <!--<div class="col-md-5 d-flex flex-column justify-content-center ps-md-5 mt-n5 mt-md-0" id="updateText">
                    <div class="logo-wrapper text-start mb-4">
                        <h1 class="display-5 mb-3" style="font-weight: 400; letter-spacing: 2.5px; margin-left: 0;">Notice & Minutes</h1>
                    </div>-->
            ...
            Our society is committed to transparency and progress. Below are some important documents and references related to our society’s Deemed Conveyance process.
               ...
               <!-- </div>
                ...
                <div class="col-md-6">
                    <p class="mb-4 fs-5 text-muted">
                        Notices and minutes are essential components of society meetings. A notice informs members in advance about upcoming meetings, including the date, time, venue, and agenda. Minutes are the official record of what was discussed and decided during the meeting, including attendance, key points, and action items. </p>
                </div>-->

                <!-- Main content: left years, center cards, right featured -->
                <div class="row g-4">
                    <!-- LEFT: years list (desktop) / accordion (mobile) -->
                    <div class="col-lg-2 d-none d-lg-block">
                        <div class="years-list ps-4">
                            <div class="year-item">
                                <div class="year-arrow" aria-hidden="true"></div>
                    ...
                    <!-- LEFT (mobile): accordion to replace years (visible on md and below) -->
                    <div class="col-12 d-lg-none mb-3">
                        <div class="accordion" id="yearsAccordion">
                            <div class="accordion-item">
                                ...
                                <div id="collapseYears" class="accordion-collapse collapse" aria-labelledby="headingYears" data-bs-parent="#yearsAccordion">
                                    <div class="accordion-body p-2">
                                        <ul class="list-unstyled mb-0">
                                            <li class="py-2 border-bottom"><a href="#" class="text-decoration-none">2025</a></li>
                                            <li class="py-2 border-bottom"><a href="#" class="text-decoration-none">2024</a></li>
                                            <li class="py-2 border-bottom"><a href="#" class="text-decoration-none">2023</a></li>
                                            <li class="py-2"><a href="#" class="text-decoration-none">2022</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
