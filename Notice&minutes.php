      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-4 mb-md-0">
          ...
          <p class="text-muted small mb-0">
            Rajul Apartments, 9, Harkness Rd, Teen Batti, Malabar Hill, Mumbai, Maharashtra 400006, a prime residential area offering comfort and convenience.
          </p>
        </div>
        ...
        <div class="col-md-6">
          ...
          <ul class="list-unstyled small text-muted">
            <li class="mb-2">- Rajul Apartments, 9, Harkness Rd, Teen Batti, Malabar Hill, Mumbai, Maharashtra 400006</li>
            <li class="mb-2">- rajulapartments@gmail.com</li>
            ...
            cardsContainer.innerHTML = `
                <div class="col-md-12">
                    <div class="p-4 shadow-sm border rounded">
                        ...
                        <img src="../pictures/room 5.jpg" alt="${month}" class="img-fluid mb-3"/>
