            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 pt-4 pt-md-0" id="pmcLeft">
                    <div class="fs-6 ms-5 ps-3 mb-4">
                        <h1 class="display-3 fw-light mb-2">Draft D.A</h1>
                        <p class="text-muted fst-italic">– Discussion for Draft D.A</p>
                    </div>
                    <div class="ms-5">
                        <p class="fs-6 mb-3">
                            The Draft Development Agreement (DA) will be uploaded on this page shortly and made available for all members to review and discuss as part of the redevelopment process. At present, this page does not contain any documents. In the meantime, members may refer to the other sections of the website for notices, minutes, and related redevelopment documents. Thank you for your patience and cooperation.
                        </p>
                        <!--<p class="fs-6 mb-4">
                ...
                <div class="col-md-6 text-center mt-5 mt-md-0" id="pmcRight">
                    <img src="./assets/images/Development-Agreement.jpg" alt="" class="img-fluid rotate-once" style="max-height: 300px;">
                </div>
            </div>
        </div>
    </section>
